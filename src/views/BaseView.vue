    ...
    <div class="relative flex min-h-[92vh] top-[8vh]">
        <div class="bg-white text-gray-700 w-full md:w-64 py-4 px-2 space-y-6 absolute inset-y-0 left-0 transform transition duration-200 ease-in-out md:relative md:-translate-x-0" :class="{ 'relative -translate-x-0': showSidebar, '-translate-x-full': !showSidebar }">
            ...
            <section class="space-y-2">
                ...
                <nav>
                    <router-link to="/audiens" class="flex items-center py-3 px-4 hover:bg-sky-100 space-x-2 hover:rounded-xl group transition duration-0 font-semibold" exact-active-class="text-blue-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                        </svg>
                        <span class="text-lg" :class="isActiveLink('/audiens') ? 'text-blue-primary font-semibold' : 'group-hover:text-cyan-700 text-gray-700'">Audiens</span>
                    </router-link>
                </nav>
                <nav>
